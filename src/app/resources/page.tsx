...
const guides = [
  ...
  ['Speech animation reference', '/resources/speech-animation-reference'],
  ['Moving hold animation reference', '/resources/moving-hold-animation-reference'],
  ['Sword swing animation reference', '/resources/sword-swing-animation-reference'],
