            ...
            <section className="relative pt-20 pb-32 text-center z-10">
                <div className="container mx-auto px-4">
                    ...
                    <div className="flex justify-center mb-8 animate-fade-in">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm shadow-[0_0_30px_-5px_rgba(109,40,217,0.3)] group hover:scale-105 transition-transform duration-300">
                    ...
                    {/* Headline */}
                    <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight mb-8 leading-[1.1] md:leading-[1.1] max-w-5xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-24">
                        <Link href="/browse">
                            <Button className="h-16 px-10 rounded-2xl text-lg font-semibold bg-gradient-to-br from-[#7c3aed] to-[#6d28d9] hover:scale-105 shadow-[0_10px_40px_-10px_rgba(124,58,237,0.5)] border border-purple-400/20 transition-all duration-300 group">
                    ...
                    {/* Hero Visual Placeholder (Browser/App Mockup) */}
                    <div className="relative mx-auto max-w-6xl">
                        <div className="absolute -inset-1 bg-gradient-to-r from-purple-500/30 to-blue-500/30 rounded-2xl blur-lg opacity-50" />
                        <div className="relative bg-[#0F0C1D] border border-white/10 rounded-xl overflow-hidden shadow-2xl aspect-[16/9] group">
                            {/* Header Dots */}
                            <div className="absolute top-0 left-0 right-0 h-10 bg-[#1a162e] border-b border-white/5 flex items-center px-4 gap-2">
                            ...
                            <div className="absolute inset-0 pt-10 flex items-center justify-center bg-[url('https://placehold.co/1920x1080/0f0c1d/3b0764?text=')] bg-cover opacity-50">
                                <div className="text-center group-hover:scale-105 transition-transform duration-700 ease-out">
                                    <div className="h-24 w-24 rounded-full bg-white/5 border border-white/10 flex items-center justify-center mx-auto mb-6 shadow-xl backdrop-blur-sm">
                                        <Play className="h-10 w-10 text-white fill-white ml-1" />
                                    </div>
                                    <p className="text-white/40 font-mono text-sm tracking-widest uppercase">Application Preview</p>
                                </div>
                            </div>
                        </div>
                    </div>
