...
export function LimitReachedDialog({ 
    ...
    const title = isLikes ? 'Free Save Limit Reached' : 'Free Moodboard Limit Reached';
            ...
            <DialogContent className="max-w-md bg-[#0b0914] border border-purple-500/30 text-white shadow-2xl rounded-3xl p-6">
                <DialogHeader className="text-center">
                    ...
                    <DialogDescription className="text-center text-zinc-400 pt-2 text-xs leading-relaxed">
                        Free tier accounts include 1 active moodboard and 5 bookmarks. Upgrade to <strong className="text-purple-300">AnimationReference Pro</strong> to unlock unlimited boards and professional animator tools.
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="my-4 p-4 rounded-2xl bg-white/[0.03] border border-white/10 space-y-2 text-xs text-zinc-300">
                    <div className="flex items-center gap-2.5">
                        ...
                        <span>Unlimited Moodboards & Spatial Canvas</span>
                    </div>
                    <div className="flex items-center gap-2.5">
                        <Check className="h-4 w-4 text-emerald-400 shrink-0 font-bold" />
                        <span>Unlimited Reference Bookmarks & Saves</span>
                    </div>
                    <div className="flex items-center gap-2.5">
                        <Check className="h-4 w-4 text-emerald-400 shrink-0 font-bold" />
                        <span>High-Resolution Moodboard & PDF Exports</span>
                    </div>
                    <div className="flex items-center gap-2.5">
                        <Check className="h-4 w-4 text-emerald-400 shrink-0 font-bold" />
                ...
                <DialogFooter className="mt-2 sm:justify-center">
                    ...
                    >
                        <span>Upgrade to Pro — Unlock Unlimited</span>
