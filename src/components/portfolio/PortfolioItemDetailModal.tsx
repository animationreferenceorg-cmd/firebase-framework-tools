...
import { toggleLikePortfolioItem, deletePortfolioItem, incrementPortfolioItemViews, incrementPortfolioItemShares, portfolioItemToVideo } from '@/lib/portfolio-service';
...
export const PortfolioItemDetailModal: React.FC<PortfolioItemDetailModalProps> = ({
  ...
  return (
    <>
      ...
      {showSaveModal && (
        <SaveToBoardModal
          video={portfolioItemToVideo(item)}
          open={showSaveModal}
