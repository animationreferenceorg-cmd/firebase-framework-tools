...
const launches = [
  {
    ...
    href: '/paint',
    image: '/announcements/paint-workspace.webp?v=3',
    icon: Paintbrush,
  ...
  },
  {
    ...
    href: '/references',
    image: '/announcements/reference-vault.webp?v=3',
    icon: Scissors,
  ...
  },
  {
    ...
    image: '/announcements/portfolio-page.webp?v=3',
    icon: UserPlus,
  ...
  },
  {
    ...
    href: '/moodboard',
    image: '/announcements/updated-boards.webp?v=3',
    icon: LayoutGrid,
